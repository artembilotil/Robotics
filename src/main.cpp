...
// Буде створено у setup() як локальна змінна
...
void setup() {
    ...
    // Тепер використовуємо динамічне виділення пам'яті
    // Це необхідно тому що GameEngine потребує посилань на інші обєкти
    // які мають довгий жиночний цикл (весь час програми)
